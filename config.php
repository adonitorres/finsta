...
define('ROOT_DIR', 'C:\xampp\htdocs\adoni\finsta' ); // for the server
define('ROOT_URL', 'http://localhost/adoni/finsta/' );  // for the browser

// Database Configuration
$database_name = 'finsta';
$database_user = 'finsta';
$database_password = '61cNfoRSBI40]2Wu';
$host = 'localhost';
